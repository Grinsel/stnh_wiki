...
const SharedRender = (() => {
    ...
    const WIKI_LINK_MAP = {
        ...
        job:            { page: 'economy.html',     param: 'search', tab: 'jobs' },
        deposit:        { page: 'economy.html',     param: 'search', tab: 'deposits' },
        resource:       { page: 'economy.html',     param: 'search', tab: 'resources' },
        megastructure:  { page: 'economy.html',     param: 'search', tab: 'megastructures' },
        relic:          { page: 'economy.html',     param: 'search', tab: 'relics' },
        ...
        ascension_perk: { page: 'governments.html', param: 'search', tab: 'perks' },
