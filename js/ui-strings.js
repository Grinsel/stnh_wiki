...
const UI_STRINGS = {
    ...
    'ui.search.global_off':    { english: 'Global search (click to enable)', german: 'Globale Suche (klicken zum Aktivieren)' },
    'ui.search.global_on':     { english: 'Global search active (click to disable)', german: 'Globale Suche aktiv (klicken zum Deaktivieren)' },
    'ui.search.global_label':  { english: 'Global Search', german: 'Globale Suche' },
