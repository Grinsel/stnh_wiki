...
MOD_COUNCILORS_DIR = os.path.join(STNH_MOD_ROOT, "common", "governments", "councilors")
MOD_GFX_COUNCIL_VIEW_ICONS = os.path.join(STNH_MOD_ROOT, "gfx", "interface", "council_view")
VANILLA_GFX_COUNCIL_VIEW_ICONS = os.path.join(VANILLA_ROOT, "gfx", "interface", "council_view")
...
VANILLA_SHIP_MODELS_DIR = os.path.join(VANILLA_ROOT, "gfx", "models", "ships")
